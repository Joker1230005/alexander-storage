# 🗄️ alexander-storage - Your Simple Storage Solution
...
4. Follow these steps based on your operating system:
   ...
   ### 🐧 Linux Installation
   - Open your terminal.
   - Use the `cd` command to navigate to the folder containing the downloaded file.
   - Run `chmod +x alexander-storage-linux` to make it executable.
   - Start it by typing `./alexander-storage-linux`.

   ### 🍏 macOS Installation
   - Open your terminal.
   - Use the `cd` command to navigate to the folder containing the downloaded file.
   - Run `chmod +x alexander-storage-macos` to make it executable.
   - Start it by typing `./alexander-storage-macos`.
